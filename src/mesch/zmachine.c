...
complex 
__zip__ (complex *zp1, complex *zp2, int len, int flag)
{
    complex	sum;
    int		i;
...
/* __zmltadd__ -- scalar multiply and add i.e. complex saxpy
	...
	-- computes zp1[i] += s.zp2[i]* if flag != 0 */
void 
__zmltadd__ (complex *zp1, complex *zp2, complex s, int len, int flag)
{
    int		i;
    LongReal	t_re, t_im;
...
void 
__zmlt__ (complex *zp, complex s, complex *out, register int len)
{
    int		i;
    LongReal	t_re, t_im;
...
void 
__zadd__ (complex *zp1, complex *zp2, complex *out, int len)
{
    int		i;
    for ( i = 0; i < len; i++ )
    {
...
void 
__zsub__ (complex *zp1, complex *zp2, complex *out, int len)
{
    int		i;
    for ( i = 0; i < len; i++ )
    {
