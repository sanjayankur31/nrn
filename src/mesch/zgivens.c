...
void 
zgivens (complex x, complex y, Real *c, complex *s)
{
	Real	inv_norm, norm;
	complex	tmp;
...
ZVEC *
rot_zvec (ZVEC *x, int i, int k, double c, complex s, ZVEC *out)
{
...
ZMAT *
zrot_rows (ZMAT *mat, int i, int k, double c, complex s, ZMAT *out)
{
	u_int	j;
	complex	temp1, temp2;
...
ZMAT *
zrot_cols (ZMAT *mat, int i, int k, double c, complex s, ZMAT *out)
{
	u_int	j;
	complex	x, y;
