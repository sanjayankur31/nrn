...
/* attach a new list of errors pointed by err_ptr
   ...
   */
int 
err_list_attach (int list_num, int list_len, char **err_ptr, int warn)
{
...
/* check if list_num is attached;
   ...
   */
int 
err_is_list_attached (int list_num)
{
 ...
 */
int 
ev_err (char *file, int err_num, int line_num, char *fn_name, int list_num)
{
   int	num;
