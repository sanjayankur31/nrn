...
/* sprow_xpd -- expand row by means of realloc()
   ...
   -- returns r */
SPROW *
sprow_xpd (SPROW *r, int n, int type)
{
   int	newlen;
...
/* sprow_merge -- merges r1 and r2 into r_out
   ...
   -- returns r_out */
SPROW *
sprow_merge (SPROW *r1, SPROW *r2, SPROW *r_out, int type)
{
...
/* sprow_copy -- copies r1 and r2 into r_out
   ...
   -- returns r_out */
SPROW *
sprow_copy (SPROW *r1, SPROW *r2, SPROW *r_out, int type)
{
   int	idx1, idx2, idx_out, len1, len2, len_out;
   row_elt	*elt1, *elt2, *elt_out;
...
/* sprow_mltadd -- sets r_out <- r1 + alpha.r2
   ...
   -- returns r_out */
SPROW *
sprow_mltadd (SPROW *r1, SPROW *r2, double alpha, int j0, SPROW *r_out, int type)
{
   int	idx1, idx2, idx_out, len1, len2, len_out;
   row_elt	*elt1, *elt2, *elt_out;
...
/* sprow_add -- sets r_out <- r1 + r2
   ...
   -- returns r_out */
SPROW *
sprow_add (SPROW *r1, SPROW *r2, int j0, SPROW *r_out, int type)
{
   int	idx1, idx2, idx_out, len1, len2, len_out;
   row_elt	*elt1, *elt2, *elt_out;
...
double 
sprow_set_val (SPROW *r, int j, double val)
{
