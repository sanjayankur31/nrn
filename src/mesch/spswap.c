...
void 
patch_col (SPMAT *A, int col, int old_row, int old_idx, int row_num, int idx)
{
    SPROW	*r;
    row_elt	*e;
...
row_elt *
chase_col (SPMAT *A, int col, int *row_num, int *idx, int max_row)
{
...
row_elt *
bump_col (SPMAT *A, int col, int *row_num, int *idx)
{
    SPROW	*r;
    row_elt	*e;
    int		tmp_row, tmp_idx;
