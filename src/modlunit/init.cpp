...
static struct { /* Keywords */
    ...
    short kval;
                ...
                VERBATIM,
                "ENDVERBATIM",
                END_VERBATIM, /* explicit in lex.lpp */
                "COMMENT",
                COMMENT,
                "ENDCOMMENT",
                END_COMMENT, /* explicit in lex.lpp */
                "TITLE",
                TITLE,
                "CONSTANT",
                CONSTANT,
                ...
                NETRECEIVE,
                "BEFORE",
                BEFORE, /* before NEURON sets up cy' = f(y,t) */
                "AFTER",
                AFTER, /* after NEURON solves cy' = f(y, t) */
                "WATCH",
                WATCH,
                "FOR_NETCONS",
                FOR_NETCONS,
